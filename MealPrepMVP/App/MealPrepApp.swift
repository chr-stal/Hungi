...
func seedRecipesIfNeeded(in context: ModelContext) {
    guard ((try? context.fetchCount(FetchDescriptor<Recipe>())) ?? 0) == 0 else { return }

    // (name, instructions, cookTime, mealType, cuisine, cal, protein, carbs, fat, ingredients[(name, qty)])
    let data: [(String, String, Int, String, String, Int, Int, Int, Int, [(String, String)])] = [
        (
            "Chicken Stir Fry",
            ...
            30, MealType.dinner, "Asian", 380, 35, 20, 18,
        ...
        (
            ...
            10, MealType.breakfast, "American", 220, 18, 3, 15,
        ...
        (
            ...
            25, MealType.dinner, "Italian", 520, 15, 72, 22,
        ...
        (
            ...
            20, MealType.dinner, "American", 310, 32, 5, 18,
        ...
        (
            ...
            30, MealType.lunch, "Asian", 450, 38, 45, 12,
        ...
        (
            ...
            15, MealType.breakfast, "American", 280, 20, 8, 18,
        ...
        (
            ...
            25, MealType.dinner, "Asian", 420, 40, 18, 20,
        ...
        (
            ...
            5, MealType.breakfast, "American", 340, 12, 58, 7,
        ...
        (
            ...
            45, MealType.lunch, "American", 290, 30, 18, 8,
    ...
    for (name, inst, time, type, cuisine, cal, prot, carb, fatG, ings) in data {
        let r = Recipe(name: name, instructions: inst,
                       cookTime: time, mealType: type, cuisine: cuisine,
